CLASS z2ui5_cl_tool_app_03 DEFINITION PUBLIC.
...
CLASS Z2UI5_CL_TOOL_APP_03 IMPLEMENTATION.
  ...
  METHOD init_table_output.
    ...
    DATA(lt_cols)   = z2ui5_cl_tool_utility=>get_fieldlist_by_table( <tab> ).
...
*        DELETE ms_view-t_tab WHERE selkz = abap_true.
      ...
      WHEN `POPUP_LAYOUT_LOAD`.
        ...
        z2ui5_cl_tool_utility=>trans_xml_2_object(
          EXPORTING
            xml  = ls_layout2-data
          IMPORTING
             data = ms_layout
      ...
      WHEN `BUTTON_SAVE_LAYOUT`.
        DATA(ls_layout) = VALUE ty_s_db_layout(
          data = z2ui5_cl_tool_utility=>trans_data_2_xml( ms_layout )
          name = mv_layout_name
          ).
