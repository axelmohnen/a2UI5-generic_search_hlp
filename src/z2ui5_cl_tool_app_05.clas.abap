CLASS z2ui5_cl_tool_app_05 DEFINITION PUBLIC.
  ...
  PUBLIC SECTION.
    ...
    DATA ms_file_popup TYPE z2ui5_cl_tool_file_api=>ty_s_file.

    DATA mt_file      TYPE STANDARD TABLE OF ty_s_file_out WITH EMPTY KEY.
    DATA ms_file_edit TYPE z2ui5_cl_tool_file_api=>ty_s_file.
...
CLASS Z2UI5_CL_TOOL_APP_05 IMPLEMENTATION.


  METHOD ui5_delete.

    z2ui5_cl_tool_file_api=>delete( ms_file-id ).
  ...
  METHOD ui5_load.
    ...
    mt_out = CORRESPONDING #( z2ui5_cl_tool_file_api=>read_all( ) ).
    ...
    TRY.
        ...
        CASE client->get( )-event.
          ...
          WHEN 'UPLOAD'.
            ...
            DATA(lv_id_new) = z2ui5_cl_tool_file_api=>create( VALUE #( data = lv_data name = mv_path file_format = lv_format ) ).
            COMMIT WORK.
          ...
          WHEN 'BUTTON_METADATA_CONFIRM'.
            z2ui5_cl_tool_file_api=>update_metadata( ms_file_popup ).
            COMMIT WORK AND WAIT.
          ...
          WHEN 'EDIT'.
            ms_file_popup = z2ui5_cl_tool_file_api=>read( id = ms_file-id ).
            CLEAR ms_file_popup-data.
            ui5_popup_metadata_display( ).


          WHEN 'EDITOR'.
            DATA(lo_Editor) = NEW z2ui5_cl_tool_app_01( ).
            lo_editor->ms_file-id = mt_out[ selkz = abap_true ]-id.
            client->nav_app_call( lo_editor ).

          WHEN 'POPUP_BASE64'.
            DATA(lv_data3) = z2ui5_cl_tool_file_api=>read( id = ms_file-id )-data.
          ...
          WHEN 'POPUP_DATA'.
            lv_data3 = z2ui5_cl_tool_file_api=>read( id = ms_file-id )-data.
            DATA(lv_data2) = z2ui5_cl_tool_utility=>decode_x_base64( lv_data3 ).
            lv_data3 = z2ui5_cl_tool_utility=>get_string_by_xstring( lv_data2 ).
            ui5_popup_data_display( lv_data3 ).
  ...
  METHOD ui5_view_init_display.
    ...
    client->view_display( z2ui5_cl_xml_view=>factory( client
         )->_cc( )->file_api( )->get_js(  "zcc_file_uploader_js(
         )->stringify( ) ).
  ...
  METHOD ui5_view_main_display.
    ...
    footer->_cc( )->file_api( )->control_upload_button( "zcc_file_uploader(
