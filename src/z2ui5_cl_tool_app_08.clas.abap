CLASS z2ui5_cl_tool_app_08 DEFINITION PUBLIC.
...
CLASS Z2UI5_CL_TOOL_APP_08 IMPLEMENTATION.


  METHOD db_load.

    ms_view = z2ui5_cl_tool_view=>db_read( ms_view-name ).
...
*      ms_view-name = z2ui5_cl_xml_view=>factory( client )->hlp_get_url_param( `view`).
    ...
    CASE client->get( )-event.
      ...
      WHEN 'DB_SAVE'.
        z2ui5_cl_tool_view=>db_create( ms_view ).
