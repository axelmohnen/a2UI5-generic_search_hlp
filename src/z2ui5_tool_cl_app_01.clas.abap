CLASS z2ui5_tool_cl_app_01 DEFINITION PUBLIC.

  PUBLIC SECTION.

    INTERFACES z2ui5_if_app.

    DATA ms_file TYPE z2ui5_tool_cl_file_api=>ty_s_file.
...
CLASS z2ui5_tool_cl_app_01 IMPLEMENTATION.
  ...
  METHOD z2ui5_if_app~main.
    ...
    IF check_initialized = abap_false.
      ...
      ms_file = z2ui5_tool_cl_file_api=>read( ms_file-id ).

      DATA(lv_data3) =  ms_file-data.
      DATA(lv_data2) = z2ui5_tool_cl_utility=>decode_x_base64( lv_data3 ).
      ms_file-data = z2ui5_tool_cl_utility=>get_string_by_xstring( lv_data2 ).
    ...
    CASE client->get( )-event.
      ...
      WHEN 'DB_SAVE'.
        ...
        DATA(ls_db) = ms_file.
        DATA(lv_readyx) = z2ui5_tool_cl_utility=>get_xstring_by_string( ls_db-data ).
        ls_db-data = z2ui5_tool_cl_utility=>encode_x_base64( lv_readyx ).

        z2ui5_tool_cl_file_api=>update_data( ls_db ).
...
*         )->input( client->_bind( ms_file-name )
                ...
                suggestionitems = client->_bind( z2ui5_tool_cl_file_api=>get_editor_type( ) ) )->get(
            )->suggestion_items(
